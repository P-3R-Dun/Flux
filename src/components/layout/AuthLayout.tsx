...
export const AuthLayout = () => {
    ...
    return (
        <div className='bg-main-gradient' onClick={handleUserInteraction}><AnimatePresence mode='wait'> {!isIntroCompleted ? <Intro key="intro-screen" onComplete={() => setIsIntroCompleted(true)} /> :
            <motion.div key='auth_layout' initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 1}} exit={{opacity: 0}} className='flex flex-col items-center justify-center min-h-screen p-6 text-white'>
                <motion.div
