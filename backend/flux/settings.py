...
# Check dynamic domen from ngrok
ENV_NGROK_DOMAIN = os.getenv("NGROK_DOMAIN")
...
if ENV_NGROK_DOMAIN:
    CSRF_TRUSTED_ORIGINS = [f'https://{ENV_NGROK_DOMAIN}']
else:
...
DJOSER = {
    ...
    'DOMAIN': ENV_NGROK_DOMAIN or 'localhost:8000',
