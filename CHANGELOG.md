...
- [[v0.1.0] - 2026-03-24: Завершення структури авторизації та реєстрації користувачів](#v010---2026-03-24)
...
- Додано команди Django для тестування системи `python manage.py clean [--all]`  
...
### ✨Додано
- Реалізована нова стандартна модель для авторизації, за розробленою ER-діаграмою <details><summary>🖼️Переглянути ER-діаграму</summary><center><img src="./src/assets/docs/diagrams/ER-diagram.png" alt="ER-діаграма" width="600"><br>ER-діаграма для бази даних</center></details>
- Реалізована система "активації" аккаунта за допомогою пошти
- Інтегровано змінні середовища `.env` для надійності системи та зручного тестування 
### 🔄Змінено
- Перероблений доступ CORS для зручного тестування, на будь-якому пристрої
